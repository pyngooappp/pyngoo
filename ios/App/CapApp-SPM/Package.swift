...
let package = Package(
    ...
    dependencies: [
        ...
        .package(name: "CcattoCapacitorInappAuth", path: "../../../node_modules/@ccatto/capacitor-inapp-auth")
    ],
    targets: [
        .target(
            name: "CapApp-SPM",
            dependencies: [
                ...
                .product(name: "CcattoCapacitorInappAuth", package: "CcattoCapacitorInappAuth")
            ]
        )
    ]
)
